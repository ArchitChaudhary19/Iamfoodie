...
import { addToCart, removeSingleItems, removeToCart, emptycartItem } from '../redux/features/cartSlice'
...
const CartDetails = () => {
  ...
  const handleIncrement = (e)=>{           //add to cart (+ sign button)
    dispatch(addToCart(e))
  }
  
  const handleDecrement = (e)=>{           //remove to cart (bin sign button)
    dispatch(removeToCart(e));
    toast.success("Item Removed ")
  }

  const handleSingleDecrement = (e)=> {    //remove single item (- sign button)
...
// eslint-disable-next-line
  const countquantity = ()=>{            // count total quantity
    let totalquantity = 0
                      ...
                      return (
                        ...
                        <tr>
                          <td>
                            ...
                            onClick={()=> handleDecrement(data.id)}><i className='fa fa-trash-alt mr-2'></i></button>
                            </td>
                            <td><div className='product-img'><img src={data.imgdata} alt="food item"></img></div></td>
